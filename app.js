...
// которые в исходном фиде числились в других разделах).
const CATEGORIES = [
...
const PRODUCTS = [
  ...
  { id: 11, cat: 'rolls', name: 'Сочный Мо', price: 390, emoji: '🍣',
  ...
  { id: 12, cat: 'rolls', name: 'Харумаки Сяке', price: 420, emoji: '🍣',
  ...
  { id: 13, cat: 'rolls', name: 'Харумаки Кани', price: 400, emoji: '🍣',
  ...
  { id: 14, cat: 'rolls', name: 'Темпура мини', price: 900, emoji: '🍣',
  ...
  { id: 15, cat: 'rolls', name: 'Дасоку (темпура, запечённый)', price: 410, emoji: '🍣',
  ...
  { id: 16, cat: 'rolls', name: 'Техас (запечённый)', price: 395, emoji: '🍣',
  ...
  { id: 17, cat: 'rolls', name: 'Куба (запечённый)', price: 395, emoji: '🍣',
  ...
  { id: 18, cat: 'rolls', name: 'Тайто (запечённый)', price: 430, emoji: '🍣',
  ...
  { id: 19, cat: 'rolls', name: 'Сёгун (запеченный)', price: 400, emoji: '🍣',
  ...
  { id: 20, cat: 'rolls', name: 'Крабик (запеченный)', price: 390, emoji: '🍣',
  ...
  { id: 21, cat: 'rolls', name: 'Вулкан (запеченный)', price: 420, emoji: '🍣',
  ...
  { id: 22, cat: 'rolls', name: 'Краб темпура', price: 380, emoji: '🍣',
  ...
  { id: 23, cat: 'rolls', name: 'Тори Темпура', price: 380, emoji: '🍣',
  ...
  { id: 24, cat: 'rolls', name: 'Чикен Ананас', price: 380, emoji: '🍣',
  ...
  { id: 25, cat: 'rolls', name: 'Самурай', price: 400, emoji: '🍣',
  ...
  { id: 26, cat: 'rolls', name: 'Лава', price: 400, emoji: '🍣',
  ...
  { id: 27, cat: 'rolls', name: 'Банзай', price: 390, emoji: '🍣',
  ...
  { id: 28, cat: 'rolls', name: 'Тори', price: 355, emoji: '🍣',
  ...
  { id: 29, cat: 'rolls', name: 'Бонито', price: 420, emoji: '🍣',
  ...
  { id: 30, cat: 'rolls', name: 'Дракон', price: 400, emoji: '🍣',
  ...
  { id: 31, cat: 'rolls', name: 'Унаги запеченный', price: 400, emoji: '🍣',
  ...
  { id: 32, cat: 'rolls', name: 'Ночная Москва', price: 400, emoji: '🍣',
  ...
  { id: 33, cat: 'rolls', name: 'Филка в кунжуте', price: 390, emoji: '🍣',
  ...
  { id: 34, cat: 'rolls', name: 'Магура темпура', price: 385, emoji: '🍣',
  ...
  { id: 35, cat: 'rolls', name: 'Креветка', price: 400, emoji: '🍣',
  ...
  { id: 36, cat: 'rolls', name: 'Калифорния', price: 355, emoji: '🍣',
  ...
  { id: 37, cat: 'rolls', name: 'Филадельфия лайт', price: 420, emoji: '🍣',
  ...
  { id: 38, cat: 'rolls', name: 'Магуро', price: 385, emoji: '🍣',
  ...
  { id: 39, cat: 'rolls', name: 'Премиум запеченый', price: 435, emoji: '🍣',
  ...
  { id: 40, cat: 'rolls', name: 'Чизролл запеченый', price: 380, emoji: '🍣',
  ...
  { id: 41, cat: 'rolls', name: 'Окинава', price: 400, emoji: '🍣',
  ...
  { id: 42, cat: 'rolls', name: 'Филадельфия', price: 455, emoji: '🍣',
    desc: 'Лосось (1% соли), творожный сыр, свежий огурец',
  ...
  { id: 43, cat: 'rolls', name: 'Ролл с огурцом', price: 220, emoji: '🍣',
  ...
  { id: 44, cat: 'rolls', name: 'Сингл запеченный', price: 380, emoji: '🍣',
  ...
  { id: 45, cat: 'rolls', name: 'Унаги темпура', price: 400, emoji: '🍣',
  ...
  { id: 46, cat: 'rolls', name: 'Хоку темпура', price: 470, emoji: '🍣',
  ...
  { id: 47, cat: 'rolls', name: 'Эби темпура', price: 400, emoji: '🍣',
  ...
  { id: 48, cat: 'rolls', name: 'Сяке темпура', price: 420, emoji: '🍣',
  ...
  { id: 49, cat: 'rolls', name: 'Санчос темпура', price: 390, emoji: '🍣',
  ...
  { id: 50, cat: 'rolls', name: 'Салмон', price: 420, emoji: '🍣',
    desc: 'Лосось (1% соли), творожный сыр, свежий огурец, икра',
  ...
  { id: 51, cat: 'rolls', name: 'Канада', price: 475, emoji: '🍣',
  ...
  // Шаурма и бурито
  { id: 66, cat: 'shaurma', name: 'Бурито с беконом', price: 360, emoji: '🌯',
  ...
  { id: 67, cat: 'shaurma', name: 'Бурито', price: 370, emoji: '🌯',
  ...
  { id: 77, cat: 'drinks', name: 'Васаби', price: 10, emoji: '🍵',
    desc: 'Выход: 10гр',
    compo: 'Выход: 10гр.',
  ...
  { id: 79, cat: 'drinks', name: 'Имбирь', price: 15, emoji: '🍵',
    desc: 'Имбирь',
  ...
  { id: 80, cat: 'drinks', name: 'Соевый соус', price: 15, emoji: '🍵',
    desc: 'Вес: 40 мл',
    compo: 'Вес: 40 мл.',
  ...
  { id: 81, cat: 'drinks', name: 'Соус ореховый', price: 50, emoji: '🍵',
    desc: 'Вес: 40 мл',
    compo: 'Вес: 40 мл.',
